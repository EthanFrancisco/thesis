...
void motorForward(int lpwm, int rpwm, int speed) {
  analogWrite(lpwm, speed);
  analogWrite(rpwm, 0);
}

void motorBackward(int lpwm, int rpwm, int speed) {
  analogWrite(lpwm, 0);
...
void loop() {
    ...
    delay(100); // Give some time to switch context
    if (sensor1Serial.available()) {
